...
class PCTransformer(nn.Module):
    ...
    def forward(self, xyz):
        ...
        if self.training:
            ...
            return q, coarse, denoise_length, (coor, fm_cond)
...
class AdaPoinTr_PGST(nn.Module):
    ...
    def get_loss(self, ret, gt, epoch=1):
        ...
        coor, fm_cond = fm_data                   # (B, G, 3), (B, G, D)  G=384
        B, G, _ = coor.shape
        ...
        t_exp = t.view(B, 1, 1)
        x_t = (1.0 - t_exp) * coor + t_exp * x_1       # interpolated positions
        v_target = x_1 - coor                            # constant velocity (OT-FM)
