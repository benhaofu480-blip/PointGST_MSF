#!/usr/bin/env bash
# FeedPoinTrS-style finetune: C sigmoid ckpt + PCN_core + two-pass loss, 50ep, seed42.
set -euo pipefail
...
LOG="/tmp/feedpointrs_ft_crop02_04_seed${SEED}.log"
...
echo "pid=$!"
echo "log=$LOG"
echo "Monitor: grep -E 'FeedPoinTrS|Validation|Early Stop' $LOG"
