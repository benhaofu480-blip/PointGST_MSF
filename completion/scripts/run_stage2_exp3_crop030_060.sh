#!/usr/bin/env bash
# Stage-2 Exp3: crop ratio ablation [0.30, 0.60], dual-pass feedback finetune.
set -euo pipefail
...
GPU="${GPU:-1}"
SEED="${SEED:-42}"
EXP="exp_stage2_exp3_crop030_060_seed${SEED}"
LOG="/tmp/stage2_exp3_crop030_060_seed${SEED}.log"
CFG="cfgs/PCN_models/AdaPoinTr_MSF_Pure_Group_sigmoid_feedpointrs_ft_crop030_060.yaml"
...
echo "exp=$EXP"
echo "log=$LOG"
echo "Monitor: grep -E 'FeedPoinTrS|Validation|Early Stop|Overall' $LOG"
