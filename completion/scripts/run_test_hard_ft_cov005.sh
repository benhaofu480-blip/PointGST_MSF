#!/usr/bin/env bash
# Official PCN test for hard_ft λ=0.05 ckpt-best.
set -euo pipefail
...
CKPT="${ROOT}/experiments/AdaPoinTr_MSF_Pure_Group_sigmoid_hard_ft_cov005/PCN_models/exp_MSF_Pure_Group_sigmoid_hard_ft_cov005/ckpt-best.pth"
CFG="cfgs/PCN_models/AdaPoinTr_MSF_Pure_Group_sigmoid.yaml"
EXP="test_hard_ft_cov005_best"
...
GPU="${GPU:-0}"
echo "Test λ=0.05 ckpt-best on GPU ${GPU}"
